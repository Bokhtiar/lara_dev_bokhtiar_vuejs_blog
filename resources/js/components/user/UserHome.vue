        ...
        <div class="carousel-item active" style="background-image: url(user/assets/img/slide/slide-1.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Welcome to <span>Blog Website</span></h2>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div v-for="blog in blogs" :key="blog.id" class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              <div class="icon">
                <img :src="imgurl(blog.image)" height="40px" width="50px" class="rounded" alt="">
              </div>
              <h4><router-link :to="`/blog/detail/${blog.id}`">{{ blog.title }}</router-link></h4>
