  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url({{ asset('user') }}/assets/img/slide/slide-1.jpg);">
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url({{ asset('user') }}/assets/img/slide/slide-2.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url({{ asset('user') }}/assets/img/slide/slide-3.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
