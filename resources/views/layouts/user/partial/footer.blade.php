        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <router-link to="/contact">Contact</router-link></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Blog</h4>
            <ul>
            @foreach (App\Models\Category::latest()->take(6)->get(); as $item)
            <li><i class="bx bx-chevron-right"></i> <a href="#">{{ $item->category_name }}</a></li>
            @endforeach
            </ul>
          </div>
